function ApprovalRequestStatus() {
    ...
    self.SetUpTable = function () {
        $.ajax({
            url: base.ApplicationBasePath() +"/api/approvalrequeststatus",
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve, reject) {
                        ...
                        model = { id: $("#requeststatusid").val(), name: $("#description").val(), code: $("#code").val() }
                        $.ajax({
                            url: base.ApplicationBasePath() +"/api/approvalrequeststatus/" + $("#requeststatusid").val(),
                            type: "PUT",
                            contentType: "application/json",
                            dataType: "json",
                            data: JSON.stringify(model),
