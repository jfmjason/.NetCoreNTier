...
var pdfjsLib;
    if (typeof window !== 'undefined' && window['lib/pdfjs/build/pdf']) {
        pdfjsLib = window['lib/pdfjs/build/pdf'];
} else {
...
function configure(PDFJS) {
    ...
    var eleminput = document.getElementById("baseinput2");

    PDFJS.imageResourcesPath = '../../..' + eleminput.dataset.apprelativepath + '/lib/pdfjs/web/images/';
    PDFJS.workerSrc = '../../..' + eleminput.dataset.apprelativepath +'/lib/pdfjs/build/pdf.worker.js';
    PDFJS.cMapUrl = '../../..' + eleminput.dataset.apprelativepath +'/lib/pdfjs/web/cmaps/';
...
var DEFAULT_URL = '../../../lib/pdfjs/web/compressed.tracemonkey-pldi-09.pdf';
;
...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: '../../../lib/pdfjs/web/debugger.js',
...
function webViewerLoad(url) {
    ...
    window.PDFViewerApplication.Config = config;
