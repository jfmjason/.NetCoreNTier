function PatientType() {
    ...
    self.SetUpTable = function () {
        $.ajax({
            url: base.ApplicationBasePath() +"/api/patienttype",
            ...
            swal({
                ...
                preConfirm: function () {
                    return new Promise(function (resolve, reject) {
                        ...
                        model = { id: $("#patienttypeid").val(), name: $("#description").val(), code: $("#code").val() }
                        $.ajax({
                            url: base.ApplicationBasePath() +"/api/patienttype/" + $("#patienttypeid").val(),
                            type: "PUT",
                            contentType: "application/json",
                            dataType: "json",
                            data: JSON.stringify(model),
